export const faqs = [
  ...
  },
  {
    ...
    answer:
      "We are based in Kibaha, in the Pwani (Coast) Region of Tanzania, and our initiatives currently focus on communities across the Kibaha area and wider Pwani region.",
  },
  {
    question: "How can I support the foundation?",
    answer:
      "You can support our mission by donating, volunteering your time and skills, or partnering with us as an organisation. Visit the Get Involved page to choose the path that suits you best.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "We welcome partnerships with schools, companies, NGOs and community groups. Use the Partner With Us page to tell us about your organisation and the area you'd like to collaborate on, and our team will get in touch.",
  },
  {
