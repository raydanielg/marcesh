export const site = {
  name: "Marcesh Foundation",
  shortName: "Marcesh",
  tagline: "Building Communities. Creating Opportunity.",
  description:
    "Marcesh Foundation works to improve lives through education, health services, community support and sustainable development in Kibaha, Pwani, Tanzania.",
  location: "Kibaha, Pwani, Tanzania",
  email: "marceshfoundation@gmail.com",
  phone: "+255 628 312 926",
  ...
  mission:
    "To provide equal opportunities for education and health services for all the people to help the needy in society and to build a society with equality and sustainable development.",
  goals: [
  ...
  socials: [
    { label: "Facebook", href: "https://facebook.com/marceshfoundation", icon: "facebook" },
    { label: "Instagram", href: "https://instagram.com/marceshfoundation", icon: "instagram" },
    { label: "YouTube", href: "https://youtube.com/@marceshfoundation", icon: "youtube" },
    { label: "LinkedIn", href: "https://linkedin.com/company/marceshfoundation", icon: "linkedin" },
    { label: "WhatsApp", href: "https://wa.me/255628312926", icon: "whatsapp" },
  ],
} as const
